...
venue: "Jimma University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Jimma University Campus"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "Ethiopia"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
...
latitude: "7.670190"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "36.833359"    # decimal longitude of the workshop venue (use https://www.latlong.net)
